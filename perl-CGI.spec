...
Version  : 4.61
Release  : 48
URL      : https://cpan.metacpan.org/authors/id/L/LE/LEEJO/CGI-4.61.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/L/LE/LEEJO/CGI-4.61.tar.gz
...
%prep
%setup -q -n CGI-4.61
cd %{_builddir}/CGI-4.61
pushd ..
cp -a CGI-4.61 buildavx2
popd
