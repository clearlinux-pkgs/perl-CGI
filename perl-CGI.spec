...
Version  : 4.60
Release  : 47
URL      : https://cpan.metacpan.org/authors/id/L/LE/LEEJO/CGI-4.60.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/L/LE/LEEJO/CGI-4.60.tar.gz
...
%prep
%setup -q -n CGI-4.60
cd %{_builddir}/CGI-4.60
pushd ..
cp -a CGI-4.60 buildavx2
popd
