...
Version  : 4.68
Release  : 61
URL      : https://cpan.metacpan.org/authors/id/L/LE/LEEJO/CGI-4.68.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/L/LE/LEEJO/CGI-4.68.tar.gz
...
%prep
%setup -q -n CGI-4.68
cd %{_builddir}/CGI-4.68
pushd ..
cp -a CGI-4.68 buildavx2
popd
