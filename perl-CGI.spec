...
Source0  : https://cpan.metacpan.org/authors/id/L/LE/LEEJO/CGI-4.47.tar.gz
...
cp %{_builddir}/CGI-4.47/LICENSE %{buildroot}/usr/share/package-licenses/perl-CGI/4ddbe6ac3bfaee77fb2e3a1c0d53f744891f2aad
if test -f Makefile.PL; then
