...
Version  : 4.66
Release  : 54
URL      : https://cpan.metacpan.org/authors/id/L/LE/LEEJO/CGI-4.66.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/L/LE/LEEJO/CGI-4.66.tar.gz
...
%prep
%setup -q -n CGI-4.66
cd %{_builddir}/CGI-4.66
pushd ..
cp -a CGI-4.66 buildavx2
popd
